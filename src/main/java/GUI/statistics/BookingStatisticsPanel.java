...
/**
 * Panel thống kê tỷ lệ đặt phòng theo loại phòng - Biểu đồ cột
 */
public class BookingStatisticsPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        legendPanel.setBorder(BorderFactory.createTitledBorder("Chi tiết theo loại phòng"));
    ...
    private void drawBarChart(Graphics g) {
        ...
        int barWidth = Math.max(30, totalBarWidth / barCount);
        ...
        for (Map.Entry<String, Double> entry : bookingData.entrySet()) {
            ...
            // Draw bar
            Color barColor = chartColors.get(colorIndex % chartColors.size());
            ...
            g2d.drawString(valueLabel, labelX, barY - 5);
            ...
            g2dRotated.translate(x + barWidth / 2, marginTop + chartHeight + 15);
        ...
        String title = "Biểu đồ số lượt đặt phòng theo loại";
        FontMetrics fm = g2d.getFontMetrics();
